...
SolidBallScrewNutPairsTableCtrl.controller("SolidBallScrewNutPairsTableCtrl",function($scope,$cookies,$stateParams,$http,$state){
	//滚珠丝杠常用精度等级数据
	$scope.accuracyClassOptions=[
	{name:"P1",factor:1,transmissionEfficiency:0.9},
	{name:"P2",factor:1,transmissionEfficiency:0.9},
	{name:"p3",factor:1,transmissionEfficiency:0.9},
	{name:"P4",factor:0.9,transmissionEfficiency:0.85},
	{name:"P5",factor:0.9,transmissionEfficiency:0.85},
	{name:"P7",factor:0.8,transmissionEfficiency:0.85},
	{name:"P10",factor:0.7,transmissionEfficiency:0.86}];
	//滚珠丝杠常用可靠性数据
	...
	$scope.reset();
	//从服务端获取滚珠丝杠数据
	$http.get("http://cncdataapi.azurewebsites.net/api/cncdata/SolidBallScrewNutPairs")
	...
	$scope.nextStep=function(){
		$cookies.putObject($stateParams.FeedSystemType+"SolidBallScrewNutPairs",$scope.ballscrewSelected);
