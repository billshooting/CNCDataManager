...
/**
 * @ngdoc directive
 * @name cncdataManagerApp.directive:alignRollerBrgsPanel
 * @description
 * # alignRollerBrgsPanel
 */
angular.module('cncdataManagerApp')
  .directive('alignRollerBrgsPanel', function (TableHandler, $modal) {
    return {
      templateUrl: '../App/views/templates/align-roller-bearings.html',
      restrict: 'E',
      scope: true,
      link: function postLink(scope) {
        // 0. 辅助方法声明
        scope.ITEMNAME = 'alignrollerbrgs/';
        ...
        scope.handlingItems = {
          deletingItem: null, addingItem: null, updatingItem: null};      //将要处理的数据行
